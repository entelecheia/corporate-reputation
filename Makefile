...
mkvirtualenv: ## create the project environment
	@python3 -m venv "$$WORKON_HOME/corporate-reputation"
	@. "$$WORKON_HOME/corporate-reputation/bin/activate"
	@pip install --upgrade pip setuptools wheel

mkvirtualenv-system: ## create the project environment with system site packages
	@python3 -m venv "$$WORKON_HOME/corporate-reputation" --system-site-packages
	@. "$$WORKON_HOME/corporate-reputation/bin/activate"
	@pip install --upgrade pip setuptools wheel
